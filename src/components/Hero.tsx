  ...
  return (
    <section id="hero" className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://drive.google.com/uc?export=view&id=1HQJQKeISNQJrRFcuKoXahc8FMbtuFPBu"
          alt="艶やかな美髪"
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto space-y-6">
        <div className="mb-6 md:mb-8 bg-white/80 backdrop-blur-md rounded-2xl max-w-4xl mx-auto p-8 shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
          ...
          <Button
            ...
            variant="outline"
            className="border-2 border-primary/30 hover:border-primary hover:bg-primary/5 px-6 md:px-10 py-4 md:py-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto backdrop-blur-sm bg-white/90"
          >
            <Tag className="w-4 h-4 md:w-5 md:h-5 mr-2" />
            <span className="text-sm md:text-base">クーポンを見る</span>
          </Button>
        </div>
      </div>
